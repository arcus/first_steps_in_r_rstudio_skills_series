...
::: {.columns .v-center-container}
::: {.column .small-text width="40%"}
![](media/posit_new_from_git_repo.png){fig-alt="Menu from the New Project button on Posit.cloud with an arrow indicating New Project from Git Repository"}
:::
::: {.column .small-text width="40%"}
![](media/new_project_with_github_url.png){fig-alt="Form titled New Project from Git Repository that includes a fill in the blank titled URL of your Git Repository."}
:::
:::
...
::: {.columns .v-center-container}
::: {.column .small-text width="40%"}
![](media/new_quarto_document.png){fig-alt="File Menu from Posit.cloud R environment, with Arrow indicating New File, Quarto Document."}
:::
::: {.column .small-text width="40%"}
![](media/create_quarto_document.png){fig-alt="New Quarto Document form which includes Title and Author.  Title is filled in with the word Setup and everything else is left as default."}
:::
:::
...
![](media/writing_first_markdown.png){fig-alt="View of a short bit of Markdown that only includes a header line with two hash marks followed by 'Installing Packages' and then a line that reads 'We need to install some packages.'"}
:::
:::
...
::: {.columns .v-center-container}
::: {.column .small-text width="40%"}
![](media/about_to_click_new_chunk.png){fig-alt="RStudio window with an arrow indicating the add new code chunk button at the top of the screen."}
:::
::: {.column .small-text width="40%"}
![](media/new_code_chunk.png){fig-alt='A new code chunk with one line of R code which reads install.packages(c("rmarkdown", "tidyverse")).'}
:::
:::
...
::: {.columns .v-center-container}
::: {.column .small-text width="40%"}
![](media/run_code_chunk.png){fig-alt="A code chunk with an arrow indicating the execute code chunk button."}
:::
::: {.column .small-text width="40%"}
![](media/install_in_progress.png){fig-alt="A code chunk and the R console, with three indicators of the code being executed indicated with arrows."}
:::
:::
...
![](media/save_file.png){fig-alt="A Save File picker that shows the exercises folder."}
